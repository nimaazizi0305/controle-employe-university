...
class Ui_control_arrivals_and_departures_employe(QWidget):
    ...
    def setupUi(self):
        self.setObjectName("control_arrivals_and_departures_employe")
        self.resize(645, 598)
        self.setWindowTitle("")
        self.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.setStyleSheet("background-color: rgb(250, 255, 149);")
...
"background-color: rgb(255, 226, 0);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/search_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_delete_by_code = QtWidgets.QPushButton(self.delete_box,clicked=lambda:self.delete_by_code())
        self.btn_delete_by_code.setGeometry(QtCore.QRect(20, 40, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_delete_by_code.setFont(font)
        self.btn_delete_by_code.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.btn_delete_by_code.setStyleSheet("background-color: rgb(196, 255, 234);")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/delete_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_delete_by_code.setIcon(icon1)
        self.btn_delete_by_code.setIconSize(QtCore.QSize(20, 20))
        self.btn_delete_by_code.setObjectName("btn_delete_by_code")
        ...
        self.enter_code_for_delete_info = QtWidgets.QLineEdit(self.delete_box)
        self.enter_code_for_delete_info.setGeometry(QtCore.QRect(140, 30, 141, 21))
        self.enter_code_for_delete_info.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.enter_code_for_delete_info.setObjectName("enter_code_for_delete_info")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/show_data_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.lbl_enetr_code.setGeometry(QtCore.QRect(400, 70, 81, 16))
        self.lbl_enetr_code.setObjectName("lbl_enetr_code")
        self.enter_enter_code = QtWidgets.QLineEdit(self.enter_part)
        self.enter_enter_code.setGeometry(QtCore.QRect(192, 70, 191, 20))
        ...
        self.btn_enter.setGeometry(QtCore.QRect(230, 130, 131, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/login_enter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_enter.setIcon(icon3)
        self.btn_enter.setIconSize(QtCore.QSize(20, 20))
        self.btn_enter.setObjectName("btn_enter")
        self.btn_exit = QtWidgets.QPushButton(self.enter_part,clicked=lambda:self.exit_employe())
        self.btn_exit.setGeometry(QtCore.QRect(230, 300, 131, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/exit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_exit.setIcon(icon4)
        self.btn_exit.setIconSize(QtCore.QSize(20, 20))
        self.btn_exit.setObjectName("btn_exit")
        self.enter_exit_code = QtWidgets.QLineEdit(self.enter_part)
        self.enter_exit_code.setGeometry(QtCore.QRect(192, 240, 191, 20))
        self.enter_exit_code.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.enter_exit_code.setObjectName("enter_exit_code")
        self.lbl_exit_code = QtWidgets.QLabel(self.enter_part)
        self.lbl_exit_code.setGeometry(QtCore.QRect(400, 240, 81, 16))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/add-user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../.designer/Python/icons/icons/edite_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def keyPressEvent(self, e):
        if e.key() == Qt.Key_Enter and self.enter_enter_code.text()!="":
            self.enter_employe()
        elif e.key() == Qt.Key_Enter and self.enter_exit_code.text()!="":
            self.exit_employe()
        elif e.key() == Qt.Key_Enter and self.enter_search_code.text()!="":
            self.search_employe()
        elif e.key() == Qt.Key_Enter and self.enter_date_search.text()!="":
            self.search_by_date()
        elif e.key() == Qt.Key_Enter and self.enter_code_for_delete_info.text()!="" and self.enter_time_enter_for_delete_by_hand.text()!="":
            self.delete_by_code()
        elif e.key() == Qt.Key_Enter and self.enter_date_time_delete.text()!="":
            self.delete_by_date()
        elif  e.key() == Qt.Key_Enter and self.enter_add_code.text()!="" and self.enter_add_name.text()!="" and self.enter_add_family.text()!="":
            self.add_employe()
        elif  e.key() == Qt.Key_Enter and self.enter_code_edite.text()!="" and self.enter_name_edite.text()!="" and self.enter_family_edite.text()!="":
            self.edite_employe()
        elif  e.key() == Qt.Key_Enter and self.enter_search_for_edite.text()!="" :
            self.search_for_edite_employe()
        elif e.key() == Qt.Key_Enter and self.enter_code_for_delete.text()!="":
            self.delete_employe()
        elif e.key() == Qt.Key_Enter and self.enter_name_excel_file.text()!="":
            self.save_Excel_file()
            
        elif e.key() == Qt.Key_Enter and self.enter_add_code.text()!="" or self.enter_add_name.text()!="" or self.enter_add_family.text()!="":
            info_msg = QMessageBox()
            info_msg.setWindowTitle("اطلاعیه")
            info_msg.setText("باید تمامی بخش ها پر شوند")
    ...
    def delete_by_code(self):
        ...
        code_for_delete_info=self.enter_code_for_delete_info.text()
        enter_time_for_delete=self.enter_time_enter_for_delete_by_hand.text()

        # Delete data
        my_cursor.execute("DELETE FROM arrivals_and_departures WHERE id=? AND (time_enter_1=? OR time_enter_2=? OR time_enter_3=? OR time_enter_4=?)",(code_for_delete_info,enter_time_for_delete,enter_time_for_delete,enter_time_for_delete,enter_time_for_delete))

        connect.commit()
        connect.close()

        self.enter_code_for_delete_info.clear()
    ...
    def add_employe(self):
        ...
        try:
            ...
            elif self.enter_add_code.text()!="" or self.enter_add_name.text()!="" or self.enter_add_family.text()!="":
                info_msg = QMessageBox()
                info_msg.setWindowTitle("اطلاعیه")
    ...
    def edite_employe(self):
        ...
        if self.enter_code_edite.text()!="" and self.enter_name_edite.text()!="" and self.enter_family_edite.text()!="":
            try:
                connect=sqlite3.connect("controle_employe_university.db")
                ...
                info_msg = QMessageBox()
                info_msg.setWindowTitle("اطلاعیه")
                info_msg.setText("اطلاعات کارمند تغییر داده شد")
                info_msg.setIcon(QMessageBox.Information)
                ...
                info_msg = QMessageBox()
                info_msg.setWindowTitle("اطلاعیه")
                info_msg.setText("برای ویرایش باید بخش  کد کارمندی حتما پر شده باشد")
                info_msg.setIcon(QMessageBox.Information)
            ...
            info_msg = QMessageBox()
            info_msg.setWindowTitle("اطلاعیه")
            info_msg.setText("برای ویرایش باید تمامی بخش  ها پر شده باشد")
            info_msg.setIcon(QMessageBox.Information)
    ...
    def save_Excel_file(self):
        ...
        try:
            ...
            my_data_frame=pd.DataFrame(my_records,columns=["کد کارمندی","نام","نام خانوادگی","ساعت ورود اول","ساعت خروج اول","ساعت ورود دوم","ساعت خروج دوم","ساعت ورود سوم","ساعت خروج سوم","ساعت ورود چهارم","ساعت خروج چهارم","تاریخ ثبت اطلاعات"])
            my_data_frame.to_excel(f"{self.enter_name_excel_file.text()}.xlsx")
            ...
            info_msg = QMessageBox()
            info_msg.setWindowTitle("اطلاعیه")
            info_msg.setText(" فایل با این نام قبلا ذخیره شده است   \n نام دیگری را انتخاب کنید")
            info_msg.setIcon(QMessageBox.Information)
    ...
    def retranslateUi(self, control_arrivals_and_departures_employe):
        ...
        self.search_box.setTitle(_translate("control_arrivals_and_departures_employe", "قسمت جستوجو با کد کارمندی و تاریخ"))
        self.lbl_code_search.setText(_translate("control_arrivals_and_departures_employe", "کد کارمند:"))
        self.btn_search.setText(_translate("control_arrivals_and_departures_employe", "جستوجو"))
        self.btn_search_by_date.setText(_translate("control_arrivals_and_departures_employe", "جستوجو"))
        ...
        self.btn_delete_by_code.setText(_translate("control_arrivals_and_departures_employe", "حذف"))
        ...
        self.enter_part.setTitle(_translate("control_arrivals_and_departures_employe", "قسمت ورود و خروج"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.enter), _translate("control_arrivals_and_departures_employe", "ورود و خروج"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Edite), _translate("control_arrivals_and_departures_employe", "بخش کارمندان"))


if __name__ == "__main__":
    app = QApplication(sys.argv)
    ex = Ui_control_arrivals_and_departures_employe()
    sys.exit(app.exec_())